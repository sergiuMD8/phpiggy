...
<section class="max-w-2xl mx-auto mt-12 p-4 bg-white shadow-md border border-gray-200 rounded">
    <form method="POST" class="grid grid-cols-1 gap-6">
        ...
        <label class="block">
            ...
            <input value="<?php echo $oldFormData['age'] ?? '' ?>" name="age" type="number" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" placeholder="" />
        ...
        <label class="block">
            ...
            <select name="country" class="block w-full mt-1 rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                ...
                <option value="Invalid" <?php echo isset($oldFormData['country']) && $oldFormData['country'] === 'Invalid' ? 'selected' : ''; ?>>Invalid Country</option>
            </select>
            <?php if (isset($errors['country'])) : ?>
                <div class="bg-gray-100 mt-2 p-2 text-red-500">
                    <?php echo htmlspecialchars($errors['country'][0]); ?>
                </div>
            <?php endif; ?>
        </label>
        ...
        <label class="block">
            ...
            <input <?php echo $oldFormData['socialMediaUrl'] ?? '' ?> name="socialMediaUrl" type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" placeholder="" />
            ...
            <div class="mt-2">
                <div>
                    <label class="inline-flex items-center">
                        <input <?php echo $oldFormData['tos'] ?? false ? 'cheked' : ''; ?> name="tos" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-offset-0 focus:ring-indigo-200 focus:ring-opacity-50" type="checkbox" />
